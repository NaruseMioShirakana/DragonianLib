...
namespace Float32
{
	...
	void InterpolateImpl(
		...
		const Tensor& _Src,
		const SizeType CurDims,
		InterpolateType _Type = InterpolateType::Nearest1D
	)
	{
		if(_Type == InterpolateType::Nearest1D)
			NearestInterpolate1DImpl(_Dst, _Src, CurDims, 1);
		else if(_Type == InterpolateType::Nearest2D)
			NearestInterpolate2DImpl(_Dst, _Src, CurDims, 2);
		else if (_Type == InterpolateType::Nearest2P)
			NearestInterpolate2PImpl(_Dst, _Src, CurDims, 2);
