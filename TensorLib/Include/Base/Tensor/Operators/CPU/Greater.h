...
constexpr int64_t _D_Dragonian_Lib_Operator_Greater_Unfold = 8;

template <typename Type>
class _Impl_Dragonian_Lib_Has_Greater_Operator
{
...
template <typename Type>
constexpr bool _Impl_Dragonian_Lib_Has_Greater_Operator_v = _Impl_Dragonian_Lib_Has_Greater_Operator<Type>::_HasOperator;

template<typename _Type>
void GreaterScalarCont(
	bool* _Dest,
	const _Type* _Src,
	SizeType DestSize,
...
{
	if constexpr (_Impl_Dragonian_Lib_Has_Greater_Operator_v<_Type>)
	{
		...
		if (ViewRank == 1)
			DoubleTensorLoop<1, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
			...
			DoubleTensorLoop<2, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<3, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<4, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<5, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<6, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<7, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<8, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<9, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<10, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
...
template <typename _Type>
void OperatorsBase<_Type, Device::CPU>::ImplGreaterScalar(
	bool* _Dest,
...
{
	if constexpr (_Impl_Dragonian_Lib_Has_Greater_Operator_v<_Type> && std::is_move_assignable_v<_Type>)
...
)
{
	if constexpr (_Impl_Dragonian_Lib_Has_Greater_Operator_v<_Type> && std::is_move_assignable_v<_Type>)
	{
		...
		if (ViewRank == 1)
			TripleTensorLoop<1, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
			...
			TripleTensorLoop<2, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<3, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<4, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<5, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<6, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<7, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<8, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<9, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<10, _D_Dragonian_Lib_Operator_Greater_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
...
template <typename _Type>
void OperatorsBase<_Type, Device::CPU>::ImplGreaterTensor(
	bool* _Dest,
	const OperatorParameter& _DestInfo,
	const _Type* _Src1,
