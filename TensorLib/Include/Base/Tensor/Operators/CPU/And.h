...
constexpr int64_t _D_Dragonian_Lib_Operator_And_Unfold = 8;

template <typename Type>
class _Impl_Dragonian_Lib_Has_And_Operator
{
...
template <typename Type>
constexpr bool _Impl_Dragonian_Lib_Has_And_Operator_v = _Impl_Dragonian_Lib_Has_And_Operator<Type>::_HasOperator;
