...
constexpr int64_t _D_Dragonian_Lib_Operator_Mul_Unfold = 8;

template <typename Type>
class _Impl_Dragonian_Lib_Has_Mul_Operator
{
...
template <typename Type>
constexpr bool _Impl_Dragonian_Lib_Has_Mul_Operator_v = _Impl_Dragonian_Lib_Has_Mul_Operator<Type>::_HasOperator;

template <typename Type>
class _Impl_Dragonian_Lib_Has_Mul_Inplace_Operator
{
	template <typename Objty>
...
template <typename Type>
constexpr bool _Impl_Dragonian_Lib_Has_Mul_Inplace_Operator_v = _Impl_Dragonian_Lib_Has_Mul_Inplace_Operator<Type>::_HasOperator;

template<typename _Type>
void MulScalarInplaceCont(
	_Type* _Dest,
	SizeType DestSize,
...
template<typename _Type>
void MulScalarInplace(
	_Type* _Dest,
	std::shared_ptr<OperatorParameter> _DestInfoOld,
	std::shared_ptr<_Type> _ValPtr
)
{
	if constexpr (_Impl_Dragonian_Lib_Has_Mul_Inplace_Operator_v<_Type>)
	{
		...
		if (ViewRank == 1)
			SingleTensorLoop<1, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 2)
			SingleTensorLoop<2, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 3)
			SingleTensorLoop<3, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 4)
			SingleTensorLoop<4, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 5)
			SingleTensorLoop<5, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 6)
			SingleTensorLoop<6, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 7)
			SingleTensorLoop<7, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 8)
			SingleTensorLoop<8, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 9)
			SingleTensorLoop<9, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else if (ViewRank == 10)
			SingleTensorLoop<10, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, Shape, Begin, ViewStep, ViewLeft, ViewStride, Func
			);
		else
...
{
	if constexpr (_Impl_Dragonian_Lib_Has_Mul_Operator_v<_Type>)
	{
		const OperatorParameter& _DestInfo = *_DestInfoOld;
		...
		if (ViewRank == 1)
			DoubleTensorLoop<1, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
			...
			DoubleTensorLoop<2, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<3, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<4, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<5, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<6, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<7, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<8, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<9, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
			...
			DoubleTensorLoop<10, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				SrcViewStep, SrcViewLeft, SrcViewStride,
...
template <typename _Type>
void OperatorsBase<_Type, Device::CPU>::ImplMulScalar(
	_Type* _Dest,
...
)
{
	if (_Dest == _Src)
	{
		if constexpr (_Impl_Dragonian_Lib_Has_Mul_Inplace_Operator_v<_Type>)
		{
			ImplMultiThreadSingle(
				...
				Continuous,
				MulScalarInplace<_Type>,
				MulScalarInplaceCont<_Type>
			);
		}
		else
			_D_Dragonian_Lib_Not_Implemented_Error;
	...
	{
		if constexpr (_Impl_Dragonian_Lib_Has_Mul_Operator_v<_Type> && std::is_move_assignable_v<_Type>)
...
)
{
	if constexpr (_Impl_Dragonian_Lib_Has_Mul_Operator_v<_Type> && std::is_move_assignable_v<_Type>)
	{
		...
		if (ViewRank == 1)
			TripleTensorLoop<1, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
			...
			TripleTensorLoop<2, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<3, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<4, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<5, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<6, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<7, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<8, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<9, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
			...
			TripleTensorLoop<10, _D_Dragonian_Lib_Operator_Mul_Unfold>(
				0, 0, 0,
				Shape, Begin,
				ViewStep, ViewLeft, ViewStride,
				Src1ViewStep, Src1ViewLeft, Src1ViewStride,
...
template <typename _Type>
void OperatorsBase<_Type, Device::CPU>::ImplMulTensor(
	_Type* _Dest,
	const OperatorParameter& _DestInfo,
	const _Type* _Src1,
	...
	if (_Dest == _Src1)
	{
		if constexpr (_Impl_Dragonian_Lib_Has_Mul_Inplace_Operator_v<_Type>)
		{
			ImplMultiThreadDouble(
				...
				nullptr,
				Continuous,
				MulTensorInplace<_Type>,
				MulTensorInplaceCont<_Type>
			);
		}
		else
			_D_Dragonian_Lib_Not_Implemented_Error;
