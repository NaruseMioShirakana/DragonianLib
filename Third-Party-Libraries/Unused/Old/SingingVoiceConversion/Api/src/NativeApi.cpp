	...
	)
{
	...
	_Input->MelFactor = 1.0f;	///< Mel factor
	...
	)
{
	...
	auto [OutPutData, OutPutSize] = ((DragonianLib::SingingVoiceConversion::SingingVoiceConversion*)_Model)->InferenceWithCrossFade(
		...
		{ _AudioSamplingRate, _Settings->HopSize, _Settings->F0Bins, _Settings->WindowSize, _Settings->F0Max, _Settings->F0Min, _Settings->UserParameter },
		_GDragonianLibSvcNullStrCheck(_F0Method),
