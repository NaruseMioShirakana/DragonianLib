...
DragonianLibSTL::Vector<float> DragonianLib::KMeansCluster::Search(float* point, long sid, int64_t n_points)
{
...
DragonianLib::KMeansCluster::KMeansCluster(const std::wstring& _path, size_t hidden_size, size_t KmeansLen)
{
	dims = hidden_size;
	FILE* file = nullptr;
