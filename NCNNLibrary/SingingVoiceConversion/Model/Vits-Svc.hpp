 ...
 */
class VitsSvc : public SingingVoiceConversionModule, public NCNNModel
{
public:
	VitsSvc() = delete;
	VitsSvc(
		...
		const std::shared_ptr<Logger>& _Logger = _D_Dragonian_Lib_NCNN_Singing_Voice_Conversion_Space GetDefaultLogger()
	);
