...
#define _D_Dragonian_Lib_NCNN_UnitsEncoder_Header \
	_D_Dragonian_NCNN_Lib_Space_Header \
	namespace UnitsEncoder {

#define _D_Dragonian_Lib_NCNN_UnitsEncoder_End } _D_Dragonian_NCNN_Lib_Space_End

#define _D_Dragonian_Lib_NCNN_UnitsEncoder_Space \
	_D_Dragonian_Lib_NCNN_Space UnitsEncoder::
 ...
 * @brief Hubert model for units encoding
 */
class HubertBase : public NCNNModel
{
public:
	HubertBase() = delete;
	HubertBase(
