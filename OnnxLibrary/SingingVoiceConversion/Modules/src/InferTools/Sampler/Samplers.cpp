...
#ifndef LIBSVC_FLOAT_TENSOR_AVX_WRP
...
ReflowEularSampler::ReflowEularSampler(Ort::Session* Velocity, int64_t MelBins, const ProgressCallback& _ProgressCallback, Ort::MemoryInfo* memory) :ReflowBaseSampler(Velocity, MelBins, _ProgressCallback, memory) {}

ReflowHeunSampler::ReflowHeunSampler(Ort::Session* Velocity, int64_t MelBins, const ProgressCallback& _ProgressCallback, Ort::MemoryInfo* memory) :ReflowBaseSampler(Velocity, MelBins, _ProgressCallback, memory) {}

ReflowPececeSampler::ReflowPececeSampler(Ort::Session* Velocity, int64_t MelBins, const ProgressCallback& _ProgressCallback, Ort::MemoryInfo* memory) :ReflowBaseSampler(Velocity, MelBins, _ProgressCallback, memory) {}

ReflowRk4Sampler::ReflowRk4Sampler(Ort::Session* Velocity, int64_t MelBins, const ProgressCallback& _ProgressCallback, Ort::MemoryInfo* memory) :ReflowBaseSampler(Velocity, MelBins, _ProgressCallback, memory) {}
