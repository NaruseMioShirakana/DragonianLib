 ...
 * @brief WaveGlow model for voice generation
 * @changes
...
class WaveGlow : public VocoderBase
{
public:
	WaveGlow() = delete;
	WaveGlow(
	...
	WaveGlow(const WaveGlow&) = default;
	WaveGlow(WaveGlow&&) noexcept = default;
	WaveGlow& operator=(const WaveGlow&) = default;
	WaveGlow& operator=(WaveGlow&&) noexcept = default;
